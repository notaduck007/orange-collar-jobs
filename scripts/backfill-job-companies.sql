-- Backfill company_id + company_package_id for jobs missing either field.
-- Distributes null-company jobs round-robin across companies that have a package.
-- Safe to re-run: only touches rows where company_id or company_package_id is NULL.
