...
export const Route = createFileRoute("/faq")({
  head: () => ({ meta: [{ title: "FAQ — DockHire" }] }),
  component: FAQ,
});

const faqs = [
  { q: "Is DockHire really free for job seekers?", a: "Yes. Searching, saving, and applying to jobs is 100% free, with no resume paywalls or premium tiers." },
  ...
  { q: "Do you support staffing agencies and 3PLs?", a: "Absolutely. Many of our largest customers run multi-site recruitment through DockHire. Contact sales for a custom plan." },
];
