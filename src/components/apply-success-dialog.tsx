...
export function ApplySuccessDialog({ open, onOpenChange, bookingStartsAt }: ApplySuccessDialogProps) {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {bookingStartsAt && (
          <div className="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
            ...
            <span>
              <span className="font-semibold">Phone screen booked for {formatBooking(bookingStartsAt)}</span>{" "}
              — we'll remind you.
            </span>
          </div>
        )}
