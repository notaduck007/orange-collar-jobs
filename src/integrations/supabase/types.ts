    ...
    Tables: {
      ...
      seeker_profiles: {
        Row: {
          ...
          created_at: string;
          desired_employment_type: Database["public"]["Enums"]["employment_type"] | null;
...
export const Constants = {
  public: {
    Enums: {
      ...
      employment_type: ["full_time", "part_time", "temp", "temp_to_hire", "seasonal", "contract"],
      job_shift: ["first", "second", "third", "weekend", "flexible"],
      job_status: ["draft", "published", "closed", "expired", "active", "paused", "pending_review"],
    },
  },
} as const;
